...
function initMap(data) {
    ...
    function getPoints() {
        ...
        for(var i = 0; i < data.length; i++) {
            var obj = data[i];
            if(obj.temp[5] > 9) {
              location[i] = {location: new google.maps.LatLng(obj.coords.lat, obj.coords.lng), weight: 10};
            } else if(obj.temp[5] > 5) {
              location[i] = {location: new google.maps.LatLng(obj.coords.lat, obj.coords.lng), weight: 5};
            } else {
              location[i] = {location: new google.maps.LatLng(obj.coords.lat, obj.coords.lng), weight: 1};
            }
  }
        return location;
    }
...
function display() {
    ...
    const URL='https://api.thingspeak.com/channels/629279/feeds.json?api_key=0EQHJXM6M0CPWY0R&results=20';
        ...
        setInterval(function(){
         $.ajax({
             ...
             success:function(dataTemp){
                 lefthome.empty();
                 rightHome.empty();
                 lefthome.append('<h1>'+dataTemp.feeds[19].created_at[0]+dataTemp.feeds[19].created_at[1]+dataTemp.feeds[19].created_at[2]+dataTemp.feeds[19].created_at[3]+dataTemp.feeds[19].created_at[4]+dataTemp.feeds[19].created_at[5]+dataTemp.feeds[19].created_at[6]+dataTemp.feeds[19].created_at[7]+dataTemp.feeds[19].created_at[8]+dataTemp.feeds[19].created_at[9]+'</h1>'),
     ...
     function displayBlocks(data){
        ...
        etime.append(data.name);
         setInterval(function(){
            ...
            if(t[0]>100){firstimg.src="hightemp.jpg";}
            else if(t[0]>90){firstimg.src="sunny.jpg";}
            else if(t[0]>80){firstimg.src="happycloud.jpg";}
            else{firstimg.src="winter.jpg";}
            
            if(t[1]>100){secondimg.src="hightemp.jpg";}
            else if(t[1]>90){secondimg.src="sunny.jpg";}
            else if(t[1]>80){secondimg.src="happycloud.jpg";}
            else{secondimg.src="winter.jpg";}
    
            
            if(t[2]>100){thirdimg.src="hightemp.jpg";}
            else if(t[2]>90){thirdimg.src="sunny.jpg";}
            else if(t[2]>80){thirdimg.src="happycloud.jpg";}
            else{thirdimg.src="winter.jpg";}
    
            
            if ( t[3] > 100){fourthimg.src="hightemp.jpg";}
            else if (t[3] >90){ fourthimg.src="sunny.jpg";}
            else if ( t[3] >80){ fourthimg.src="happycloud.jpg";}
            else { fourthimg.src="winter.jpg";}
    
            
            if ( t[4] > 100){fifthimg.src="hightemp.jpg";}
            else if (t[4] >90){ fifthimg.src="sunny.jpg";}
            else if ( t[4] >80){ fifthimg.src="happycloud.jpg";}
            else { fifthimg.src="winter.jpg";}
    
            if(t[5] > 100){sixthimg.src="hightemp.jpg";
